...
public class ModifiedExpressionDebuggerEvaluateActionHandler extends XDebuggerActionHandler {
    private final String modifiedExpression;

    public ModifiedExpressionDebuggerEvaluateActionHandler(String modifiedExpression) {
    ...
    private void showDialog(@NotNull XDebugSession session,
                            VirtualFile file,
        ...
        if (expression.getLanguage() == null) {
            ...
            expression = new XExpressionImpl(modifiedExpression, language, expression.getCustomInfo(), expression.getMode());
        }
